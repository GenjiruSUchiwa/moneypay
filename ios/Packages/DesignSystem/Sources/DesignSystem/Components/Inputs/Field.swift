...
#Preview("Field") {
    ...
    VStack(spacing: 12) {
        Field(placeholder: "Full name", text: $empty)
        Field(placeholder: "Full name", text: $filled, icon: "person")
        Field(placeholder: "Phone", text: $empty, icon: "phone", keyboard: .phonePad)
    }
    .gutter()
    .page()
}
