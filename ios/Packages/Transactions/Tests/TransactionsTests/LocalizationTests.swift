...
@Suite("Transactions — string catalog")
struct LocalizationTests {
    ...
    @Test("the activity list and detail read in French")
    func transactionCopyIsTranslated() {
        #expect(french("Breakdown") == "Décompte")
        #expect(french("Total debited") == "Total débité")
    }
}
