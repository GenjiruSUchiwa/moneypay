...
internal static class CreatePhoneVerificationEndpoint
{
    public static IEndpointRouteBuilder MapCreatePhoneVerification(this IEndpointRouteBuilder routes)
    {
        ...
        routes.MapPost(SignUpRoutes.PhoneVerifications, VerifyAsync)
            ...
            .Accepts<JsonApiRequest<JsonApiRequestResource<CreatePhoneVerificationAttributes>>>(
    ...
    private static async Task<IResult> VerifyAsync(
        Guid signUpId,
        JsonApiRequest<JsonApiRequestResource<CreatePhoneVerificationAttributes>> request,
        ...
        CancellationToken cancellationToken)
    {
        ...
        SignUpRelationships.RequireMatch(id, request.Data.Relationships);
